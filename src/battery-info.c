        ...
        enum DischargeStrategy strategy, int threshold)
{
    ...
    if(force_discharge)
    {
        if(strategy == DISCHARGE_LEAPFROG)
        {
            if(discharge0)
            {
                if(percent1 - percent0 > threshold)
                    force1 = 1;
                else if(percent0 > threshold)
                    force0 = 1;
            }
            else if(discharge1)
            {
                if(percent0 - percent1 > threshold)
                    force0 = 1;
                else if(percent1 > threshold)
                    force1 = 1;
            }
            else if(percent0 > threshold && percent0 > percent1)
                force0 = 1;
            else if(percent1 > threshold && percent1 > percent0)
                force1 = 1;
        }
        else if(strategy == DISCHARGE_CHASING)
        {
            if(percent0 - percent1 > threshold)
                force0 = 1;
            else if(percent1 - percent0 > threshold)
                force1 = 1;
        }
    }
        ...
        const int brackets[], int bracketsSize, int bracketsPrefBat)
{
    ...
    else if(strategy == CHARGE_LEAPFROG)
    {
        ...
        else if(percent0 - percent1 > threshold)
